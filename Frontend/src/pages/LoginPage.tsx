    ...
    <div className="min-h-screen bg-surface-light dark:bg-surface-dark flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-1">Welcome back</h1>
        ...
        <div className="card p-8 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              <input {...register('email', { required: 'Email is required', pattern: { value: /\S+@\S+\.\S+/, message: 'Invalid email' } })}
                type="email" placeholder="you@example.com" className="input" autoComplete="email" />
            ...
            <div>
              ...
              <div className="relative">
                <input {...register('password', { required: 'Password is required', minLength: { value: 6, message: 'Min 6 characters' } })}
                  type={showPass ? 'text' : 'password'} placeholder="••••••••" className="input pr-11" autoComplete="current-password" />
            ...
            <button type="submit" className="btn-primary w-full justify-center py-3 text-base shadow-glow" disabled={loading}>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">Don't have an account?{' '}
              <Link to="/signup" className="text-brand-600 hover:text-brand-700 font-semibold">Create one →</Link>
            </p>
          </div>
        </div>
      </div>
